...
namespace Azmoonak.Database.Migrations
{
    ...
    [Migration("20230904182257_chertopert")]
    partial class chertopert
    {
            ...
            modelBuilder.Entity("Azmoonak.Database.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("96fb1d9b-87c0-499a-9a9a-5509c6fcd077"),
                            RoleName = "admin",
                            RoleTitle = "مدیر"
                        },
                        new
                        {
                            Id = new Guid("33c7947f-4b9f-415f-88c9-6b93cc819e8b"),
                            RoleName = "user",
                            RoleTitle = "کاربر"
                        });
                });
            ...
            modelBuilder.Entity("Azmoonak.Database.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("de775be7-78df-4ba4-a019-4b06aeaf5531"),
                            FName = "میلاد",
                            IsActive = true,
                            LName = "حیدرپور",
                            Mobile = "09030826556",
                            Password = "C4-65-39-0D-14-88-0E-D0-87-DC-E9-8C-CC-E7-D8-93",
                            RoleId = new Guid("96fb1d9b-87c0-499a-9a9a-5509c6fcd077")
                        });
                });
